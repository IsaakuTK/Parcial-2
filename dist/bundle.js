...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_export__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/export */ \"./src/components/export.ts\");\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data */ \"./src/data.ts\");\n/* harmony import */ var _data2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./data2 */ \"./src/data2.ts\");\n/* harmony import */ var _components_card_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/card/card */ \"./src/components/card/card.ts\");\n/* harmony import */ var _components_button_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/button/button */ \"./src/components/button/button.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\n\nclass AppContainer extends HTMLElement {\n    constructor() {\n        super();\n        this.jokess = [];\n        this.buttons = [];\n        this.attachShadow({ mode: \"open\" });\n    }\n    connectedCallback() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const data = yield (0,_data__WEBPACK_IMPORTED_MODULE_2__.cat)();\n            console.log(data);\n            data === null || data === void 0 ? void 0 : data.forEach((siu) => {\n                const button = this.ownerDocument.createElement(\"chis-button\");\n                button.setAttribute(_components_button_button__WEBPACK_IMPORTED_MODULE_5__.AttributtesButton.name, siu);\n                this.buttons.push(button);\n            });\n            const data2 = yield (0,_data2__WEBPACK_IMPORTED_MODULE_3__.jokes)();\n            console.log(data2);\n            data2 === null || data2 === void 0 ? void 0 : data2.forEach((e) => {\n                const prof = this.ownerDocument.createElement(\"chis-card\");\n                prof.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_4__.Attributtes.icon_url, e.icon_url);\n                prof.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_4__.Attributtes.idu, e.id);\n                prof.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_4__.Attributtes.url, e.url);\n                prof.setAttribute(_components_card_card__WEBPACK_IMPORTED_MODULE_4__.Attributtes.value, e.value);\n                this.jokess.push(prof);\n            });\n            this.render(this.jokess);\n        });\n    }\n    render(jokess) {\n        var _a, _b, _c;\n        if (this.shadowRoot)\n            this.shadowRoot.innerHTML = ``;\n        const css = this.ownerDocument.createElement(\"style\");\n        css.innerHTML = _index_css__WEBPACK_IMPORTED_MODULE_1__[\"default\"];\n        (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(css);\n        this.buttons.forEach((s) => {\n            var _a;\n            (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(s);\n        });\n        const card = this.ownerDocument.createElement(\"section\");\n        card.className = \"card\";\n        for (let index = 0; index < jokess.length; index++) {\n            card.appendChild(jokess[index]);\n        }\n        (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.appendChild(card);\n        const something = this.ownerDocument.createElement('div');\n        (_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.appendChild(something);\n    }\n}\ncustomElements.define('app-container', AppContainer);\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/index.ts?");
